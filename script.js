...
function calculateTrueAPI() {
  ...
  // --- EXACT NUMERICAL INTEGRATION FOR PRHP (Trapezoidal Rule) ---
  ...
  // Convert absolute area to PRHP: (Area in-lbs * SPM) / (12 in/ft * 33000 ft-lbs/min)
  ...
  if (use_sinker) {
    ...
    let W_sb_air = 4.167; // Validated density for 1.25" bar
